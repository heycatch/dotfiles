start https://github.com/microsoft/terminal
start https://github.com/intel/haxm
start https://github.com/qemu/qemu
start https://github.com/hiyohiyo/CrystalDiskInfo
start https://github.com/FarGroup/FarManager
start https://github.com/obsproject/obs-studio
start https://github.com/x64dbg/x64dbg
start https://github.com/processhacker/processhacker
...
start https://github.com/videolan/vlc
