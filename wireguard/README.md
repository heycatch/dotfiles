...
# 4) MTU = 1420 определяет максимальный размер пакета данных (в байтах), который может быть передан по определенному
# сетевому интерфейсу или каналу. Установка правильного MTU помогает избежать фрагментации пакетов, что повышает
# производительность и снижает задержку через туннель. Самое распространенное значение - 1420. А самый популярный диапазон
# 1400 - 1500.
